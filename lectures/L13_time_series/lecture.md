...
- [P.02](https://drc-cs.github.io/cs326/lectures/L10_recommendation_modeling/#/26) grades will be released by tomorrow (05.10)
- [H.04](https://github.com/drc-cs/cs326/tree/main/homeworks/H04) to be released today (05.09)
    - [H.04](https://github.com/drc-cs/cs326/tree/main/homeworks/H04) will be due on 05.21.
- Office hours today from 12:20P to 1:20P in G31.
...
## Entrance Poll
On a scale of 1-10, please state your level of confidence in your understanding of time series analysis / forecasting models such as ARIMA.
...
<div>
<img src="https://www.lokad.com/images/technology/probabilistic-forecasting-graph_huaa74e6c01f204738dbdb786393913645_43619_700x433_resize_q75_h2_box_3.webp" style="margin: 0 auto; display: block;">
...
<img src="https://storage.googleapis.com/blogs-images/ciscoblogs/1/2020/03/0e3efdd8-differencing.png" width="400" style="margin: 0 auto; display: block; border-radius: 10px;">
...
# H.04 | unsupervised_machine_learning.py
Due: 05.21.2024
...
There are two new requirements for H.04: <span class="code-span">statsmodels</span> and <span class="code-span">matplotlib</span>. You will need to pull the repo and update your conda environment!
...
Let's do a walkthrough of H.04 together.
</div>
